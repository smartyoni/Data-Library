...
const BookmarkCard: React.FC<BookmarkCardProps> = ({ bookmark, onEdit, onDelete }) => {
  ...
  return (
    <a
      ...
      className="group flex flex-col items-center justify-center gap-2 p-3 rounded-lg border-2 transition-all hover:scale-105 aspect-square cursor-pointer relative"
      style={{
